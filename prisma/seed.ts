...
const POSTS = [
  {
    ...
    gjsHtml: 'Voici le contenu complet de l\'article sur Next.js...',
    status: PostStatus.PUBLISHED, // Statut : 'DRAFT', 'PUBLISHED', ou 'ARCHIVED'
  ...
  },
  {
    ...
    gjsHtml: 'Voici le contenu détaillé de l\'article expliquant pourquoi Prisma est si puissant...',
  ...
  },
  {
    ...
    gjsHtml: 'Voici le contenu complet de l\'article sur les meilleures pratiques avec React...',
    status: PostStatus.PUBLISHED,
    publishedAt: new Date(),
    authorId: '47e5b5a5-87ca-49ec-8011-4ef03edb0162', // ID de l\'auteur
    categoryId: null,
  ...
  },
  {
    ...
    gjsHtml: 'Voici le contenu complet sur les hooks React...',
    status: PostStatus.PUBLISHED,
    publishedAt: new Date(),
    authorId: '47e5b5a5-87ca-49ec-8011-4ef03edb0162', // ID de l\'auteur
    categoryId: null,
