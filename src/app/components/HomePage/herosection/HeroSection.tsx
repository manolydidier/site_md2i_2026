...
export default function Hero3D() {
  ...
  const heroRefs = useMemo(() => ({
    rootRef, canvasRef, eyebrowRef, titleRef, descRef, btnsRef,
    stepsRef, progressRef, statsRef,
    topLeftTitleRef, topLeftTextRef,
    topRightTitleRef, topRightTextRef,
    bottomLeftTitleRef, bottomLeftTextRef,
    bottomRightTitleRef, bottomRightTextRef,
    styles,
  }), [])
