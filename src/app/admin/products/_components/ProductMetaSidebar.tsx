...
interface ProductMetaSidebarProps {
  ...
  onClose: () => void
  meta: ProductMeta
  onMetaChange: React.Dispatch<React.SetStateAction<ProductMeta>>
...
export default function ProductMetaSidebar({
  open,
  onClose,
  meta,
  onMetaChange,
  ...
  const update = <K extends keyof ProductMeta>(field: K, value: ProductMeta[K]) => {
  ...
  const handleRegenerateSlug = () => {
    const s = generateSlug(meta.name)
    update('slug', s)
    checkSlug(s)
  }
  ...
  return (
    <>
      ...
      <aside className="meta-sidebar meta-sidebar--open">
        <div className="sidebar-header">
          <div className="sidebar-heading">
            ...
            <div>
              <h2 className="sidebar-title">Product Settings</h2>
        ...
        <div className="sidebar-body">
          ...
          <div className="field-group">
            ...
            {!checkingSlug && slugAvailable === true && (
              <p className="field-hint field-hint--success">Slug is available ✓</p>
            )}
          </div>
      ...
      <style jsx>{`
        ...
        .field-textarea::placeholder { color: ${c.textMute}; }
        ...
        .status-btn--draft.active {
          background: ${dark ? 'rgba(255,255,255,.07)' : 'rgba(0,0,0,.045)'};
          color: ${c.text};
          border-color: ${c.border};
        }
