...
import { ProductMeta } from './ProductMetaSidebar'
  ...
  return (
    <header className="editor-header">
      <div className="editor-header__left">
        <button className="btn-icon" onClick={onBack} title="Back to products">
        ...
        <div className="editor-breadcrumb">
          <span className="breadcrumb-root">Products</span>
          <span className="breadcrumb-sep">/</span>
          <span className="breadcrumb-current">
            {meta.name || (mode === 'create' ? 'New Product' : 'Edit Product')}
          </span>
        </div>
      ...
      <div className="editor-header__right">
        ...
        <button className="btn-draft" onClick={onSaveDraft} disabled={isSaving}>
          {isSaving ? (
        ...
        <button className="btn-publish" onClick={onPublish} disabled={isSaving}>
          {isSaving ? (
