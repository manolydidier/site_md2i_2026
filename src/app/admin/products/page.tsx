...
export default function ProductsPage() {
  ...
  if (!permLoading && !can('products', 'canRead') && !can('products', 'canList')) {
    return (
      <div style={{ padding: '4rem', textAlign: 'center' }}>
        <div style={{ fontSize: 42, marginBottom: 14 }}>🔒</div>
        <p style={{ fontSize: 15, fontWeight: 600, color: t.TEXT_MAIN, margin: '0 0 8px' }}>Accès refusé</p>
        <p style={{ fontSize: 13, color: t.TEXT_MUTED, margin: 0 }}>Vous n'avez pas la permission de consulter les produits.</p>
      </div>
    )
  }
