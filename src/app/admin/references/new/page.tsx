...
const DEFAULT_COUNTRY = COUNTRY_BY_NAME['France'];
...
export default function NewReferencePage() {
  ...
  const [form, setForm] = useState({
    ...
    code: DEFAULT_COUNTRY.code.toLowerCase(),
    lat: DEFAULT_COUNTRY.lat,
    lng: DEFAULT_COUNTRY.lng,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await api.post('/api/references', payload);
      ...
      <header className="topbar">
        <div className="topbar-left">
          ...
          <div className="title-wrap">
            ...
            <p>Créer une fiche projet claire, épurée et simple à publier</p>
          </div>
        </div>
